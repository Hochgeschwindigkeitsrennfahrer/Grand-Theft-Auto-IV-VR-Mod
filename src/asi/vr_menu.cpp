...
const Row kRows[] = {
    ...
    {Kind::Value, "Eye separation", "Stereo baseline. Lower fuses easier, higher looks smaller.",
     &MenuGetSepCm, &MenuSetSepCm, 1, 12, 1, "cm", nullptr, nullptr, false, nullptr},
    {Kind::Value, "Stereo strength", "Disparity multiplier. Higher = stronger 3D, smaller world.",
     &MenuGetStereoScalePercent, &MenuSetStereoScalePercent, 100, 140, 5, "%", nullptr, nullptr,
     false, nullptr},
    {Kind::Preset, "World scale preset", "Paired FOV add + stereo strength. Open12 is the default.",
     &GetWsPreset, &SetWsPreset, 0, 0, 1, nullptr, &WsPresetName, &WsPresetCount, false, nullptr},
    {Kind::Value, "World scale (6DoF)", "Lean scale. Above about 150% fusion usually breaks.",
     &MenuGetWorldScalePercent, &MenuSetWorldScalePercent, 50, 200, 5, "%", nullptr, nullptr, false,
     nullptr},
    {Kind::Value, "FOV add", "Degrees added to the camera FOV. Higher = more canvas crop.",
     &MenuGetFovAddDegrees, &MenuSetFovAddDegrees, 0, 40, 1, "deg", nullptr, nullptr, false,
     nullptr},
    {Kind::Value, "Eye canvas", "Per-eye render target cap. Costs GPU. No effect on flat.",
    ...
    {Kind::Value, "First-person FOV", "Engine FOV for the first-person camera.", &GetFpFov,
     &SetFpFov, 60, 130, 5, "deg", nullptr, nullptr, false, nullptr},
