...
**User:** Mode 37 still huge/monitor, jump, bad FPS; F7 doesn’t feel like being in the world; read optical-flow AER synthesis Patreon.<br>
...
**Research:**  / Halo / L4D2 / UEVR / FusionFix — kill monitor-on-face with **true engine FOV**, not canvas zoom / theater. FusionFix `fixes.ixx` = cam process CALL then `*(CCam+0x60) += n*5` = our Mode 17 recompute site.<br>
